...
import { Fingerprint, Zap, Calendar, ShieldCheck, RefreshCcw, Loader2, BrainCircuit, Activity } from "lucide-react";
        ...
        <div className="flex items-start justify-between mb-12 relative z-10">
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[10px] font-black tracking-[0.5em] text-white/80 uppercase">听觉基因解构</span>
            </div>
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center gap-6 py-12">
              ...
              <div className="text-center space-y-2">
                ...
                <div className="text-[8px] font-mono text-white/20 uppercase tracking-widest">Accessing Aesthetic DNA Matrix</div>
              </div>
            </div>
          ) : !dnaJournal ? (
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-6">
              ...
              <div className="space-y-2">
                <div className="text-sm font-black text-white/40 uppercase tracking-widest italic">暂未建立神经连接</div>
                <button 
                  onClick={handleGenerate}
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-12">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[11px] font-black tracking-[0.4em] text-indigo-400 uppercase">你是 “{dnaJournal.archetype}”</span>
                </div>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center gap-3 opacity-30">
                  ...
                  <span className="text-[9px] font-black tracking-[0.3em] uppercase">深度解构 / NEURAL ANALYSIS</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-10 pt-8 border-t border-white/5">
                <div className="space-y-2">
                  <div className="text-[8px] font-black tracking-widest uppercase text-white/20">主导流派 / DOMINANCE</div>
                  <div className="text-[12px] font-bold tracking-[0.1em] text-white/70 uppercase truncate">{dnaJournal.genre}</div>
                </div>
                <div className="space-y-2">
                  <div className="text-[8px] font-black tracking-widest uppercase text-white/20">解析时间 / TIMESTAMP</div>
                  <div className="text-[12px] font-bold tracking-[0.1em] text-white/70">{formattedDate}</div>
                </div>
              </div>
            </motion.div>
          )}
