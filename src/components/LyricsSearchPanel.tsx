                    ...
                    <form onSubmit={handleSearch} className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        <button
                          type="submit"
                          disabled={isLoading}
                          className="flex-1 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-medium hover:opacity-90 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                          {isLoading ? (
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-3 justify-end">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white transition-all"
                          >
                            保存
                          </button>
                        </div>
