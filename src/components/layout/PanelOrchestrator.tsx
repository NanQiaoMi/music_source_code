...
const FACTORIES = {
  ...
  aiAgent: () =>
    import("@/components/ai-agent/AIAgentPanel").then((m) => ({ default: m.AIAgentPanel })),
  shelf3D: () =>
...
export function PanelOrchestrator() {
  ...
  return (
    <>
      ...
      <LazyPanel
        name="aiAgent"
        isOpen={panels.aiAgent}
        onClose={() => closePanel("aiAgent")}
        component={PANEL_COMPONENTS.aiAgent}
      />
