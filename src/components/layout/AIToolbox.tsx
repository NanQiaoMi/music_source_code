            ...
            <div className="p-4 space-y-4">
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  />
                  <span className="text-[9px] text-purple-400 font-bold uppercase tracking-wider">Neural Online</span>
                </div>
              </motion.div>
              ...
              <motion.div variants={ITEM_VARIANTS} className="pt-2 border-t border-white/5">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] text-white/50 group-hover:text-red-300">清理 AI 缓存</span>
                  </div>
