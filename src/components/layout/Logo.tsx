  ...
  return (
    ...
    >
      <svg viewBox="0 0 200 200" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          d="M 140 145 Q 175 150 175 110 Q 175 90 160 85"
          fill="none"
          stroke="url(#catDarkLogo)"
          strokeWidth="18"
          strokeLinecap="round"
          filter="url(#softShadowLogo)"
        />
        <path
          d="M 50 150 Q 25 150 25 120 Q 25 105 35 95"
          fill="none"
          stroke="url(#catBlueLogo)"
          strokeWidth="16"
          strokeLinecap="round"
          filter="url(#softShadowLogo)"
        />
        ...
        <g filter="url(#softShadowLogo)">
          ...
          <path
            d="M 87 95 A 38 38 0 0 1 163 95 A 36 36 0 0 0 87 95 Z"
            fill="#FFFFFF"
            opacity="0.3"
          />
          ...
          <rect
            ...
            fill="#E65100"
            opacity="0.4"
            transform="rotate(15 135 70)"
          />
          <ellipse cx="125" cy="110" rx="16" ry="12" fill="#FFF8E1" />
          <circle cx="125" cy="104" r="3" fill="#EF5350" />
          <path
            d="M 125 107 Q 120 114 116 110 M 125 107 Q 130 114 134 110"
            fill="none"
            stroke="#795548"
            strokeWidth="2.5"
            strokeLinecap="round"
        ...
        <g filter="url(#softShadowLogo)">
          ...
          <path
            d="M 36.5 108 A 36 36 0 0 1 108.5 108 A 34 34 0 0 0 36.5 108 Z"
            fill="#FFFFFF"
            opacity="0.7"
          />
          ...
          <path
            d="M 72.5 119 Q 68 125 64 121 M 72.5 119 Q 77 125 81 121"
            fill="none"
            stroke="#546E7A"
            strokeWidth="2"
            strokeLinecap="round"
          />
          <path
            d="M 53 110 Q 59 104 65 110 M 80 110 Q 86 104 92 110"
            fill="none"
            stroke="#455A64"
            strokeWidth="3"
            strokeLinecap="round"
        ...
        <g filter="url(#softShadowLogo)">
          <path
            d="M 30 110 A 45 45 0 0 1 115 110"
            fill="none"
            stroke="url(#silverLogo)"
            strokeWidth="7"
            strokeLinecap="round"
          />
        ...
        />
        <path
          d="M 51 151 L 51 158 M 58 151 L 58 158"
          stroke="#B3E5FC"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
        ...
        <g filter="url(#softShadowLogo)">
          ...
          />
          <path
            d="M 94 140 L 96 138 M 90 143 L 92 141"
            stroke="#4E342E"
            strokeWidth="1.5"
            strokeLinecap="round"
            opacity="0.5"
        ...
        <g filter="url(#glowLogo)">
          <path
            d="M 40 45 C 40 45 32 37 32 32 C 32 27 40 27 40 32 C 40 27 48 27 48 32 C 48 37 40 45 40 45 Z"
            fill="#FF8A80"
            opacity="0.8"
          />
          <path
            d="M 140 30 L 140 15 L 148 20"
            fill="none"
            stroke="#18FFFF"
            strokeWidth="3"
            strokeLinecap="round"
