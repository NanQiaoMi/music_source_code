...
import { Award, ChevronUp, Volume2, VolumeX, Disc3 } from "lucide-react";
          ...
          {isExpanded && (
            <div className="overflow-hidden">
              <div className="px-4 pb-3 space-y-3">
                ...
                >
                  <div
                    className="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-500/70 to-purple-500/70 rounded-full"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 relative h-1 bg-white/[0.08] rounded-full overflow-hidden">
                    ...
                    />
                    <div
                      className="absolute top-0 left-0 h-full bg-white/[0.5] rounded-full pointer-events-none"
